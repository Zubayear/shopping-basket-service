...
func NewShoppingBasketEndpoints() []*api.Endpoint {
	return []*api.Endpoint{
		...
		},
		{
			...
			Path:    []string{"/api/events/{id}"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
			Name:    "ShoppingBasket.CreateBasket",
			Path:    []string{"/api/shoppingbaskets/{userId}/{couponCode}"},
			Method:  []string{"POST"},
			Body:    "",
			Handler: "rpc",
		},
		{
			...
			Path:    []string{"/api/shoppingbaskets/{basketId}"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
		...
		},
		{
			...
			Path:    []string{"/api/shoppingbaskets/{basketLineId}"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
