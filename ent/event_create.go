...
func (ec *EventCreate) SetOwnerID(id uuid.UUID) *EventCreate {
...
func (ec *EventCreate) SetNillableOwnerID(id *uuid.UUID) *EventCreate {
	if id != nil {
		ec = ec.SetOwnerID(*id)
	}
	return ec
...
func (ec *EventCreate) SetOwner(b *BasketLine) *EventCreate {
	return ec.SetOwnerID(b.ID)
}
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if nodes := ec.mutation.OwnerIDs(); len(nodes) > 0 {
		...
		_node.basket_line_event = &nodes[0]
